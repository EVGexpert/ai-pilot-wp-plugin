<?php
/**
 * AI Pilot API - Diagnostics Module
 * 
...
add_action('rest_api_init', function () {
    aipilot_register_route('/diagnostics/health', [
        'methods'             => 'GET',
        'callback'            => 'aipilot_remote_get_site_health',
        'permission_callback' => function () { return aipilot_verify_token_and_can('site_info'); },
    ]);

    aipilot_register_route('/diagnostics/server', [
        'methods'             => 'GET',
        'callback'            => 'aipilot_remote_get_server_info',
        'permission_callback' => function () { return aipilot_verify_token_and_can('site_info'); },
    ]);
});

/**
 * Получить упрощённый отчёт о здоровье сайта.
 *
 * @return WP_REST_Response
 */
function aipilot_remote_get_site_health() {
    try {
...
/**
 * Получить информацию о серверном окружении.
 *
 * @return WP_REST_Response
 */
function aipilot_remote_get_server_info() {
